...
**Everything you watch and listen to. One app.**

A free, open-source app for Windows. Find any movie or series and see which streaming platform has it, watch the trailer, save it to your list — or play your own files, Google Drive, YouTube and music with a real mpv player.

[**Download for Windows**](https://github.com/5645hm-a11y/omniflux-player-releases/releases/latest) · [Website](https://5645hm-a11y.github.io/omniflux-player/) · [Français](README.fr.md)
...
| | |
|---|---|
| 🍿 **Where to watch** | One search across Netflix, Prime Video, Disney+, Max, Apple TV+, Canal+ and more for your country. Each result shows where it's included, where to rent it and where to buy it. |
| ⭐ **Your subscriptions first** | Tick the services you pay for, and titles included in them are marked and ranked first. |
| 🔥 **Trending, trailers, My list** | A home screen with this week's movies and series, trailers that play in the app, cast, ratings, and a watch-later list. |
...
| 🔎 **Unified music search** | Your files, Drive, YouTube, Deezer and Spotify in one box. Each song appears once, and you pick where it plays from. |
...
| 🌍 **8 languages** | English, French, Spanish, German, Italian, Portuguese, Arabic and Hebrew. |

## Screenshots

<table>
<tr>
<td width="50%"><img src="docs/screenshots/en-search.webp" alt="Search across streaming platforms" /><br /><sub><b>Search:</b> your library first, then every platform, marked Included, Rent or Buy</sub></td>
...
<tr>
<td><img src="docs/screenshots/en-music-search.webp" alt="Unified music search" /><br /><sub><b>Music search:</b> one result per song, with a source picker</sub></td>
